...
- **Membership Types**: Includes paid memberships (Premium, Pro) and free memberships (Free Trial, Standard Membership, Referral Reward Standard Membership).
- **Pro Membership**: Paid membership benefits.
- **Premium Membership**: Premium paid membership benefits, offering faster speeds and additional device connections compared with Pro.
- **Standard Membership**: Free membership obtained through advertisements or promotional activities, with benefits below Pro level.
- **Referral Reward Standard Membership**: Earned by successfully referring new users who register and complete their first payment, offering the same benefits as Standard Membership.
...
- **Subscription Purchase**: You may purchase Pro or Premium memberships on a monthly, quarterly, or annual basis.
- **One-time Purchase**: You may purchase a fixed-term Pro or Premium membership service by making a single payment.
- **Referral Rewards**: By successfully referring a new user who registers and makes their first payment, you may receive Standard Membership time based on that user's first paid membership: a first-time Pro purchase grants you 1 month of Standard Membership, and a first-time Premium purchase grants you 2 months. The gifted duration is calculated in natural months from the effective time of that first purchase and is not affected by later upgrades or downgrades. Please refer to the invitation page for detailed rules.
...
- **Example 1**: If you purchase a monthly Pro membership at 8:00 AM (Singapore Standard Time) on February 1, 2025, the membership will expire at 8:00 AM (Singapore Standard Time) on March 1, 2025, and manual repurchase is required after expiry;
- **Example 2**: If you purchase a monthly Pro membership at 10:00 AM (Singapore Standard Time) on January 31, 2025, since February has no 31st day, the membership will expire at 10:00 AM (Singapore Standard Time) on February 28, 2025, and manual repurchase is required after expiry.

**Subscription Renewal Examples**:

- **Example 3**: If you subscribe to monthly Pro membership (auto-renewal) at 10:00 AM (Singapore Standard Time) on January 31, 2025, the first billing cycle will expire and auto-renew at 10:00 AM (Singapore Standard Time) on February 28, 2025, and the second billing cycle will expire at 10:00 AM (Singapore Standard Time) on March 31, 2025 (restoring the original date of 31st).
...
- **Example**: If you redeem a 1-day Standard membership at 2:00 PM (Singapore Standard Time) on February 1, 2025, it will expire at 2:00 PM on February 2, 2025.
  **Referral Reward Standard Membership**:
- When the referred user makes their first Pro purchase, the referrer receives 1 month of Standard Membership; when the first purchase is Premium, the referrer receives 2 months.
- The gifted duration is calculated in natural months from the time the referred user's first paid membership becomes effective. For example, if the referred user first purchases Pro at 10:00 AM (Singapore Standard Time) on February 1, 2025, the 1-month Standard Membership will expire at 10:00 AM on March 1, 2025.
...
|------------------|---------------------|-------------------------|
| **Pro** | Enjoy Pro membership privileges | 2 desktop devices + 2 mobile devices |
| **Premium** | Enjoy faster speeds, additional device connections, and premium membership privileges | 8 devices (no distinction, tablets count as mobile devices) |
...
|-----------------|-------------------|---------------------|------------------------|
| **Standard Membership** | Obtained through watching advertisements or participating in activities on mobile devices (phones, tablets) | Enjoy Standard membership services | 1 desktop device + 1 mobile device |
| **Referral Reward Standard Membership** | Obtained by referring new users who successfully register and make their first payment | Enjoy Standard Membership services | 1 desktop device + 1 mobile device |
...
Remaining time for the same type of membership (e.g., multiple Premiums or multiple Pros) will be automatically combined for use.
Different types of memberships will take effect in the following order of priority:

1. **Premium Membership** (paid Premium)
2. **Pro Membership** (paid Pro)
3. **Standard Membership** (including Referral Reward Standard Membership)
...
- Users may upgrade their current subscription purchase by paying the corresponding price difference (these upgrade rules do not apply to one-time purchases). Upgrades are divided into the following two categories:
  - Type Upgrade (Pro → Premium, same or longer duration)
    1. Monthly Pro → Monthly/Quarterly/Annual Premium
    2. Quarterly Pro → Quarterly/Annual Premium
    3. Annual Pro → Annual Premium
  - Duration Upgrade (same type, longer duration)
    1. Monthly Pro → Quarterly/Annual Pro
    2. Quarterly Pro → Annual Pro
    3. Monthly Premium → Quarterly/Annual Premium
    4. Quarterly Premium → Annual Premium
...
- **Example**: If a user subscribes to monthly Pro at 10:00 AM (Singapore Standard Time) on January 1 and upgrades to monthly Premium at 3:00 PM on January 3, the user enjoys monthly Premium benefits from 3:00 PM on January 3, but the service period of the subscription service remains January 1, 10:00 AM through February 1, 10:00 AM.
...
- Users must not obtain Standard membership fraudulently through malicious practices. If such malicious practices or other malicious conduct are detected, AcmeVPN reserves the right to issue warnings, restrict functions, suspend services, ban accounts, or terminate membership services.
