...
- **Trial period restrictions**: Free trials are only available to new users, and each account can only enjoy one 3-day free Pro trial. Deleting the account and re-registering will not grant free trial privileges again;
- **Trial end**: After the trial period ends, if you have not purchased a paid membership and have not obtained Standard Membership, the account will return to non-member status;
...
### 3.6 What Behaviors May Result in Standard Membership Revocation?

 Standard Memberships have specific usage guidelines, and violations may result in revocation:

- **Malicious practices**:
  - Using technical means to automatically batch-view advertisements;
  - Obtaining Standard Membership rewards maliciously through multiple accounts;
  - Using virtual devices or emulators to obtain rewards.
- **Violation consequences**:
  - Standard Membership privileges shall be immediately revoked;
  - Obtained Standard Membership duration shall be cleared;
...
Given that we provide every new user with a 3-day free Pro trial to fully experience and evaluate service quality prior to payment:
...
- One-time purchase (no auto-renewal):
  - If you selected a one-time purchase (such as purchasing a fixed-term Pro membership) without auto-renewal, you will not be charged again after payment;
...
- Possibility of unexpected charges:
  ...
  - Service upgrade: For example, upgrading from Pro to Premium membership, the price difference payment may appear as an additional charge.
...
Yes. AcmeVPN Pro membership can be upgraded to Premium membership. Compared with Pro membership, Premium membership provides more benefits, such as supporting 8 devices online simultaneously, as well as faster, smoother network services and customer support.
...
- **Type upgrade** (Pro → Premium, same or longer duration):
  - Monthly Pro → Monthly/Quarterly/Annual Premium;
  - Quarterly Pro → Quarterly/Annual Premium;
  - Annual Pro → Annual Premium.
- **Duration upgrade** (same type, longer subscription duration):
  - Monthly Pro → Quarterly/Annual Pro;
  - Quarterly Pro → Annual Pro;
  - Monthly Premium → Quarterly/Annual Premium;
  - Quarterly Premium → Annual Premium.
...
- **Example**: If a user subscribes to monthly Pro at 10:00 AM Singapore Standard Time on January 1 and upgrades to monthly Premium at 3:00 PM on January 3, the user enjoys monthly Premium benefits from 3:00 PM on January 3, but the subscription service period remains from 10:00 AM on January 1 to 10:00 AM on February 1.

### 4.11 How Are Unused Pro Membership Benefits Handled After Upgrading to Premium?

- According to our refund policy, we do not offer refunds;
- Upon upgrade completion, you will immediately enjoy upgraded Premium membership benefits. However, the validity period of services shall remain based on the start time of the original subscription and shall not be reset;
- Unused Pro membership time shall be retained according to membership priority rules. After Premium membership expires, remaining Pro membership time shall automatically take effect;
...
- **Example 1**: If you purchase a one-time monthly Pro membership at 8:00 AM Singapore Standard Time on February 1, 2025, the membership will expire at 8:00 AM Singapore Standard Time on March 1, 2025, and requires manual repurchase after expiration;
- **Example 2**: If you purchase a one-time monthly Pro membership at 10:00 AM Singapore Standard Time on January 31, 2025, since February does not have 31 days, the membership will expire at 10:00 AM Singapore Standard Time on February 28, 2025, and requires manual repurchase after expiration.

**Subscription Renewal Examples**:

- **Example 3**: If you subscribe to monthly Pro membership (auto-renewal) at 10:00 AM Singapore Standard Time on January 31, 2025, the first billing cycle will expire and auto-renew at 10:00 AM Singapore Standard Time on February 28, 2025, and the second billing cycle will expire at 10:00 AM Singapore Standard Time on March 31, 2025 (resuming the original date of the 31st);
- **Example 4**: If you subscribe to quarterly Pro membership (auto-renewal) at 2:00 PM Singapore Standard Time on February 15, 2025, the first billing cycle will expire and auto-renew at 2:00 PM Singapore Standard Time on May 15, 2025, and the second billing cycle will expire at 2:00 PM Singapore Standard Time on August 15, 2025;
- **Example 5**: If you subscribe to annual Pro membership (auto-renewal) at 8:00 PM Singapore Standard Time on March 1, 2025, the first billing cycle will expire and auto-renew at 8:00 PM Singapore Standard Time on March 1, 2026.
...
### 4.14 How Can I Obtain Standard Membership?

Standard membership is free membership obtained through specific methods:
...
- **Service benefits**: Enjoy Standard membership services, supporting 1 desktop device + 1 mobile device connection simultaneously;
- **Validity period calculation**: Expires 24 hours after redemption (based on the time zone at the time of redemption);
- **Usage priority**: Automatically takes effect after all Premium and Pro membership services end;
- **Important notes**: Maliciously obtaining Standard membership shall result in revocation, and services may be terminated.
...
- **Priority order**:
  1. Premium membership (paid Premium) - highest priority;
  2. Pro membership (paid Pro only);
  3. Standard membership (advertisement reward memberships, including Referral Reward Standard Membership) - lowest priority.
- **Stacking rules**:
...
- **Example**: If you have 30 days Premium + 60 days Pro + 10 days Standard, Premium membership is automatically used first, then Pro membership, and finally Standard membership.
...
### 4.17 Can Pro and Premium Be Upgraded or Downgraded at Any Time?
...
- **Premium membership advantages**: Premium members enjoy faster network speeds and priority channels.
...
- **Unlimited traffic policy**: All membership types (free trial, Pro, Premium, Standard membership) enjoy unlimited traffic with no usage limits;
...
Yes. Any user who registers successfully for the first time is entitled to a 3-day free Pro trial. We recommend fully testing server connection speed and stability during the free trial period to ensure the service meets your usage needs.
