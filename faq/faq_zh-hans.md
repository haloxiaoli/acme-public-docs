...
### 8.2 推荐好友有什么奖励吗？
我们设有推荐奖励计划：
- **推荐奖励**：当被推荐用户首次购买 VIP 时，推荐人可获赠 1 个月轻享会员；首次购买 SVIP 时，赠送 2 个月轻享会员，均按自然月计算；
- **奖励权益**：推荐奖励轻享会员享有轻享会员服务（1 台桌面设备 + 1 台移动设备）；
- **有效期计算**：赠送时长自被推荐用户首次付费会员生效时刻起算自然月，与后续升级或降级无关；
- **使用优先级**：推荐奖励轻享会员按照会员优先级规则管理（详见会员服务条款）。
