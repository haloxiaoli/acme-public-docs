...
- **優先順序**：
  ...
  2. VIP 會員（付費 VIP）；
  3. 輕享會員（廣告獎勵會員，含推薦獎勵輕享會員）- 最低優先順序。
- **疊加規則**：
  - 同類型會員可以疊加，展示總剩餘時長；
  - 不同類型會員按優先順序使用；
...
### 8.2 推薦好友有什麼獎勵嗎？
我們設有推薦獎勵計畫：
- **推薦獎勵**：當被推薦用戶首次購買 VIP 時，推薦人可獲贈 1 個月輕享會員；首次購買 SVIP 時，贈送 2 個月輕享會員，皆按自然月計算；
- **獎勵權益**：推薦獎勵輕享會員享有輕享會員服務（1 台桌面裝置 + 1 台行動裝置）；
- **有效期計算**：贈送時長自被推薦用戶首次付費會員生效時刻起算自然月，不受後續升降級影響；
- **使用優先順序**：推薦獎勵輕享會員按照會員優先順序規則管理（詳見會員服務條款）。
