...
為保障帳戶安全和服務品質，我們不允許使用臨時電子郵件註冊：

- **安全考量**：臨時電子郵件容易被惡意利用，無法保障帳戶安全；
- **服務穩定**：臨時電子郵件影響重要通知的及時送達，如帳戶安全提醒、服務更新等；
- **帳戶管理**：無法透過臨時電子郵件進行帳戶驗證、帳戶復原等重要操作；
- **風控措施**：我們有權對使用臨時電子郵件註冊的帳戶進行風控，包括封號處理；
- **建議使用**：請使用 Gmail、Outlook、QQ 電子郵件等長期穩定的電子郵件服務進行註冊。
...
- 檢查常用電子郵件：
  - 認真回想您可能用於註冊 AcmeVPN 的電子郵件地址（如個人電子郵件、工作電子郵件等）；
  - 檢查這些電子郵件的收件匣或垃圾郵件資料夾，查找來自 AcmeVPN 的註冊確認郵件或通知郵件。

如果您忘記了註冊電子郵件地址，請聯絡客服並提供付款詳細資訊作為身份證明，我們將協助處理。

### 2.4 如何變更註冊的電子郵件地址？

目前 AcmeVPN 暫不支援變更已註冊的電子郵件地址。電子郵件是我們帳戶體系的重要識別，為保障帳戶安全和資料一致性，暫不支援修改。如需使用其他電子郵件，建議您建立新帳戶。如有任何疑問或需要幫助，請聯絡客服。
...
- **Standard 會員**：1 台行動裝置；
- **Pro 會員**：2 台桌面裝置 + 2 台行動裝置；
- **Premium 會員**：8 台裝置（不區分裝置類型）。
...
- **試用期限制**：免費試用僅適用於新用戶，每個帳戶只能享受一次 3 天免費 Pro 會員試用。註銷帳戶後重新註冊將無法再次獲得免費試用權限；
- **試用結束**：試用期結束後，如果沒有購買付費會員，且沒有獲得 Standard 會員，帳戶將回到非會員狀態；
- **付費會員影響**：一旦您購買付費會員，免費試用期將立即結束且無法復原；
- **服務切換**：從試用期到付費會員的切換是無縫的，不會影響正常使用；
- **建議**：請在試用期內充分測試伺服器連線速度、穩定性和應用功能，確保服務符合需求。

### 3.6 什麼行為可能導致 Standard 會員資格被取消？

Standard 會員有特定的使用規範，違規行為可能導致資格作廢：

- **惡意刷取行為**：
  - 使用技術手段自動批次觀看廣告；
  - 透過多個帳戶惡意獲取 Standard 會員獎勵；
  - 使用虛擬裝置或模擬器刷取獎勵。
- **違規後果**：
  - Standard 會員資格立即作廢；
  - 已獲得的 Standard 會員時長將被清零；
  - 嚴重情況可能導致帳戶被封禁；
...
鑑於我們為每位新用戶提供 3 天免費 Pro 會員試用，您可在付費前充分體驗和評估服務品質，因此：
...
- 一次性購買（無自動續費）：
  - 如果您選擇的是一次性購買（如購買固定期限的 Pro 會員），沒有自動續費功能，付款後不會再次被扣費；
...
- 意外扣費的可能性：
  ...
  - 服務升級：例如從 Pro 會員升級成為 Premium 會員，補差價時可能看起來像額外扣費。
...
- 自動續費服務取消後，會員權益在目前週期結束前仍可使用；
- 如果以上方法無效，可透過 AcmeVPN 網站或應用中的幫助中心聯絡客服。

### 4.10 Pro 會員可以升級成為 Premium 會員嗎？

可以的。AcmeVPN 的 Pro 會員可以升級成為 Premium 會員。Premium 會員相比 Pro 會員，它提供更多權益，例如支援 8 台裝置同時線上，以及更快、更流暢的網路服務和客服支援。
...
- **類型升級**（Pro → Premium，時長相同或變長）：
  - 月度 Pro → 月度/季度/年度 Premium；
  - 季度 Pro → 季度/年度 Premium；
  - 年度 Pro → 年度 Premium。
- **時長升級**（同一類型，訂閱時長延長）：
  - 月度 Pro → 季度/年度 Pro；
  - 季度 Pro → 年度 Pro；
  - 月度 Premium → 季度/年度 Premium；
  - 季度 Premium → 年度 Premium。

**重要說明**：

- 升級完成後，用戶即刻享受升級後的服務權益；
- 但服務有效期的起算時間仍為原訂閱的開始時間，不因升級而變更；
- **範例**：用戶於新加坡標準時間 2025 年 1 月 1 日 10:00 訂閱月度 Pro，並於新加坡標準時間 2025 年 1 月 3 日 15:00 升級為月度 Premium，則該用戶自新加坡標準時間 2025 年 1 月 3 日 15:00 起享受月度 Premium 權益，但其訂閱服務週期仍自新加坡標準時間 2025 年 1 月 1 日 10:00 起算，到期時間為新加坡標準時間 2025 年 2 月 1 日 10:00。

### 4.11 升級為 Premium 會員後，原 Pro 會員未使用的權益如何處理？

- 根據我們的退款政策，我們不提供退款服務；
- 升級完成後，您將立即享受升級後的 Premium 會員權益。但服務有效期的起算時間仍為原訂閱的開始時間，不因升級而變更；
- 未使用的 Pro 會員時長會按照會員優先順序規則進行保留。當 Premium 會員到期後，剩餘的 Pro 會員時長將自動生效；
...
- **範例 1**：如您於新加坡標準時間 2025 年 2 月 1 日 8:00 一次性購買月度 Pro 會員，則該會員將在新加坡標準時間 2025 年 3 月 1 日 8:00 到期，到期後需手動重新購買；
- **範例 2**：如您於新加坡標準時間 2025 年 1 月 31 日 10:00 一次性購買月度 Pro 會員，由於 2 月沒有 31 日，該會員將在新加坡標準時間 2025 年 2 月 28 日 10:00 到期，到期後需手動重新購買。

**訂閱續費範例**：

- **範例 3**：如您於新加坡標準時間 2025 年 1 月 31 日 10:00 訂閱月度 Pro 會員（自動續費），第一個計費週期將在新加坡標準時間 2025 年 2 月 28 日 10:00 到期並自動續費，第二個計費週期將在新加坡標準時間 2025 年 3 月 31 日 10:00 到期（恢復原日期 31 日）；
- **範例 4**：如您於新加坡標準時間 2025 年 2 月 15 日 14:00 訂閱季度 Pro 會員（自動續費），第一個計費週期將在新加坡標準時間 2025 年 5 月 15 日 14:00 到期並自動續費，第二個計費週期將在新加坡標準時間 2025 年 8 月 15 日 14:00 到期；
- **範例 5**：如您於新加坡標準時間 2025 年 3 月 1 日 20:00 訂閱年度 Pro 會員（自動續費），第一個計費週期將在新加坡標準時間 2026 年 3 月 1 日 20:00 到期並自動續費。
...
### 4.14 如何獲得 Standard 會員？

Standard 會員是透過特定方式獲得的免費會員：
...
- **使用優先順序**：在所有 Premium 和 Pro 會員服務結束後自動生效；
- **注意事項**：惡意刷取 Standard 會員將導致資格作廢，帳戶可能被封禁。
...
- **優先順序**：
  1. Premium 會員（付費 Premium）- 最高優先順序；
  2. Pro 會員（付費 Pro）；
  3. Standard 會員（廣告獎勵會員，含推薦獎勵 Standard 會員）- 最低優先順序。
- **疊加規則**：
  - 同類型會員可以疊加，展示總剩餘時長；
  - 不同類型會員按優先順序使用；
  - 未使用的會員時長會保留在帳戶中，按優先順序自動生效；
- **範例**：如果您有 30 天 Premium + 60 天 Pro + 10 天 Standard，先自動使用 Premium 會員，再使用 Pro 會員，最後使用 Standard 會員。
...
- **網路環境**：
  ...
  - **公共 Wi-Fi**：在咖啡廳、機場等公共場所，VPN 可以提供額外的安全保護；
...
- **處理原則**：
  - AcmeVPN 不承擔因不可抗力導致的服務中斷責任（詳見《服務條款》第 9.2 章）；
...
- **最佳化建議**：
  ...
  - 在網路使用高峰期避免使用高負載伺服器；
  - 確保本地網路連線穩定。
- **Premium 會員優勢**：Premium 會員享受更快的網路速度和優先通道。
...
- 帳戶資訊：僅需您的電子郵件地址作為註冊和登入憑證，採用電子郵件驗證碼方式進行身份認證，無需設定使用者名稱或密碼；
...
- 權利行使：如需行使上述任何權利，請透過 AcmeVPN 網站或應用中的幫助中心聯絡我們，我們通常將在 30 天內回覆（具體時限可能因您所在地區的法律規定而有所不同，詳見《隱私權政策》第 8.9 章）。

### 6.5 我的資料會被儲存多長時間？

AcmeVPN 按照最小化原則儲存用戶資料：

- **個人帳戶資料**：您的註冊資訊（如電子郵件地址）將保留至您主動要求註銷帳戶或服務終止；
...
- **首先聯絡我們**：透過 AcmeVPN 網站或應用中的幫助中心與我們聯絡，我們通常將在 30 天內調查並回覆（具體時限可能因您所在地區的法律規定而有所不同，詳見《隱私權政策》第 8.9 章）。
- **監管機構投訴**：
...
- **無限流量政策**：所有會員類型（免費試用、Pro、Premium、Standard 會員）均享受無限流量，無任何使用量限制；
...
- 資料最小化：我們嚴格遵循資料最小化原則，只收集為提供 VPN 服務所必需的最少量個人資料，包括註冊電子郵件和基本的技術統計資料；
...
- **加密標準**：根據《隱私權政策》第 10.1 章，我們使用高階加密技術保護所有資料傳輸。
- **安全等級**：
  - 採用軍用等級的加密演算法；
  - 最大程度保護資料傳輸安全；
  - 有效防止第三方竊聽和資料截取。
...
- **用戶責任**：
  - 用戶需確保下載內容的合法性；
  - 承擔因內容傳輸產生的所有法律責任（詳見《服務條款》第 5.2 章）；
  - 違反智慧財產權的行為將面臨服務終止風險。
...
- 有限資料：由於我們的無日誌政策，我們無法提供用戶的 VPN 使用活動資料，只能提供帳戶相關的基本資訊（如註冊電子郵件、註冊時間等）；
...
有的。任何用戶首次註冊成功後，都享有 3 天免費 Pro 會員試用。建議您在免費試用期間充分測試伺服器連線速度與穩定性，確保服務符合您的使用需求。
...
- **推薦獎勵**：
  - 當被推薦用戶首次購買 Pro 會員時，推薦人可獲贈 1 個月 Standard 會員；
  - 當被推薦用戶首次購買 Premium 會員時，推薦人可獲贈 2 個月 Standard 會員；
- **獎勵權益**：推薦獲贈 Standard 會員享有 Standard 會員服務（1 台行動裝置）；
- **有效期計算**：贈送時長自被推薦用戶首次付費會員生效時刻起按自然月計算，不受後續升降級影響；
- **使用優先順序**：推薦獲贈 Standard 會員按照會員優先順序規則管理（詳見《會員服務條款》）。
...
- **應用內通知**：
  ...
  - 新功能和最佳化會透過應用推送通知。
- **電子信件通知**：
  - 對於條款的重大變更，AcmeVPN 將透過電子信件、應用程式內通知或網站公告等方式提前告知用戶（詳見《服務條款》第 4.3 章）。
- **官方網站**：
  - 最新的《服務條款》、《隱私權政策》等文件更新；
  - 服務狀態和維護公告。
- **通知內容**：
  - 服務條款修改（詳見《服務條款》第 4 章）；
  - 隱私權政策變更（詳見《隱私權政策》第 17 章）；
  - 系統維護和服務中斷通知；
  - 新功能發布和最佳化更新。
- **建議**：請確保您的註冊電子郵件有效，並定期查看應用內通知。
